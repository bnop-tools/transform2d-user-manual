...
> [!TIP] Advanced Tip!
>
> Guide data is saved as a `ScriptableObject` asset in your project at `Assets/tools.bnop.transform2d/GuidesList`, which allows you to copy sets between projects.
